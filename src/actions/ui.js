...
const images = [
	...
	require("../../assets/gif-maker(1).png"),
	require("../../assets/gif-maker(2).png"),
	require("../../assets/gif-maker(3).png"),
	require("../../assets/gif-maker(4).png"),
	require("../../assets/gif-maker(5).png"),
	require("../../assets/gif-maker(6).png"),
	require("../../assets/gif-maker(7).png"),
	require("../../assets/gif-maker(8).png"),
	require("../../assets/gif-maker(9).png"),
	require("../../assets/gif-maker.png"),
